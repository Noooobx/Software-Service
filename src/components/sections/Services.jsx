  ...
  const serviceList = [
    {
      ...
      description: 'Custom web and enterprise solutions built for scale.',
      icon: (
    ...
    },
    {
      ...
      description: 'ERP, CRM, and business system integrations.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a2 2 0 114 0v1a2 2 0 01-2 2H3m14 0a2 2 0 00-2 2v10a2 2 0 002 2h3a2 2 0 002-2V7a2 2 0 00-2-2h-3z" />
        </svg>
      ),
    },
    {
      title: 'Supply of IT Goods',
      description: 'Hardware procurement and IT infrastructure supply.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Smart surveillance and security systems.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Tailored solutions for various business sectors.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
